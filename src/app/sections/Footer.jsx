          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex ">
              <a
                ...
                className="relative group flex items-center justify-center w-10 h-10 rounded-full overflow-hidden"
              >
                ...
                <svg
                  className="w-5 h-5 text-black z-10 relative transition-colors duration-300 group-hover:text-white"
                  fill="currentColor"
                  viewBox="0 0 24 24"
                  aria-hidden="true"
                >
              ...
              <a
                href="https://www.instagram.com/qlineprint"
                target="_blank"
                rel="noopener noreferrer"
                className="relative group flex items-center justify-center w-10 h-10 rounded-full overflow-hidden"
              >
